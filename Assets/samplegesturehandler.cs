...
public class samplegesturehandler : MonoBehaviour, IManipulationHandler, ISpeechHandler
{
    /*
     * Serializable
     */
    ...
    [Tooltip("The reference to the Capsule Game Object")]
    [SerializeField]
    ...
    public void OnManipulationUpdated(ManipulationEventData eventData)
    {
        ...
        {
            Capsule.transform.localScale *= 1.0f-(eventData.CumulativeDelta.z * rescaleSensitivity * Time.deltaTime);
        }
    ...
    public void OnSpeechKeywordRecognized(SpeechEventData eventData)
    {
        ...
        if (eventData.RecognizedText == "rotate mode")
        {
            isRotationMode = true;
            isRescaleMode = false;
            isMoveMode = false;
        ...
        else if (eventData.RecognizedText == "move mode")
        {
        ...
        else if (eventData.RecognizedText=="rescale mode")
        {
            isRescaleMode = true;
            isRotationMode = false;
            isMoveMode = false;
