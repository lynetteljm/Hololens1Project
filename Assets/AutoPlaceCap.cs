...
public class AutoPlaceCap : MonoBehaviour, IInputClickHandler
{
    #region Singleton
    /// <summary>
    /// Singleton instance
    /// </summary>
    public static AutoPlaceCap Instance { get; private set; }
    #endregion
    ...
    private void OnPlanesCreated(object source, EventArgs args)
    {
        ...
        List<GameObject> ceilingPlanes = new List<GameObject>();
        ...
        GenerateItemsInWorld(caps, ceilingPlanes);
    }
    ...
    private void GenerateItemsInWorld(List<capsule> capsuleList, List<GameObject> surfaces)
    {
        ...
        foreach (capsule cap in capsuleList)
        {
            ...
            if (index >= 0)
            {
                ...
                /*****************************************************/
                // Orientate the capsule and take the plane's surface normal into consideration
                cap.transform.up = plane.SurfaceNormal;
            }
